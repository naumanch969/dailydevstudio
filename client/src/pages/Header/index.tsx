    ...
    <main className="bg-white md:py-28 sm:py-20 py-16 flex flex-col md:gap-24 sm:gap-20 gap-16 justify-center items-center ">
      ...
      >
        <div className="flex flex-col justify-center items-center md:gap-8 gap-6 ">
          <h1 className="text-center md:text-9xl sm:text-7xl text-5xl font-mulish font-light leading-[100%] tracking-tight">
            {" "}
            <span className="gradient-text ">Elevate Your</span> <br /> Digital
            Presence{" "}
          </h1>
          <p className="text-center text-3xl text-gray-500 mt-12 font-inter leading-10">
            High-end website and app development for startups and companies
            where attention to detail and passion dedication matter.
          </p>
        </div>
        <HoverButton className="p-2  text-primary-blue font-bold font-mulish text-[18px]  ">
      ...
      >
        <div className="bg-black rounded-xl w-full relative md:p-8 sm:p-6 p-4 lg:h-[40rem] md:h-[36rem] sm:h-[32rem] h-[18rem] flex justify-center items-center ">
          <img
            src={Header_bg}
            alt="Header Bg"
            className="w-full h-full object-cover absolute top-0 right-0 md:p-8 sm:p-6 p-4 rounded-xl "
          />
          <img
            src={Header_fg}
            alt="Header Fg"
            className="z-[2] h-[82%] w-[90%] rounded-xl "
          />
        </div>
      </motion.div>
    </main>
